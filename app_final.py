...
def render_ders_modulu(ders_adi, ders_veri, modul):
    ...
    # Modül Navigasyonu (Konu Anlatımı, PDF Sonuç Kontrol, Deneme Sınavı)
    ...
    if modul == "Konu Anlatımı":
        ...
        # Görsellerde sadece ana başlık (Örn: 7. Sınıf Din Kültürü Tüm Üniteler) gösterildiği için
        # Konu Adı Girişi bu modülde kaldırıldı.
