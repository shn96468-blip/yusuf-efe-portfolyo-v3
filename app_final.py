...
if 'ai_response' not in st.session_state:
    st.session_state.ai_response = "Konuyu yazın ve Akıl'dan Konu Anlatmasını isteyin. (Örn: Rasyonel Sayılar, Melekler, Personality)"
...
def generate_ai_explanation(topic):
    ...
    # ===============================================
    # 7. SINIF DİN KÜLTÜRÜ KONULARI (AKTİF)
    # ===============================================
    ...
    # ===============================================
    # 7. SINIF İNGİLİZCE KONULARI (AKTİF)
    # ===============================================
