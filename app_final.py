...
* **1. Ünite:** Melekler ve Ahiret İnancı (Görülen ve Görülemeyen Varlıklar, Hz. İsa, Nâs Suresi)
* **2. Ünite:** Hac ve Kurban (Haccın Yapılışı, Umre, Kurban İbadeti, Hz. İsmail)
* **3. Ünite:** Ahlaki Davranışlar (Güzel ahlaki tutumlar, Hz. Salih, Felak Suresi)
* **4. Ünite:** Allah’ın Kulu ve Elçisi: Hz. Muhammed (s.a.v.) (Kâfirun Suresi)
* **5. Ünite:** İslam Düşüncesinde Yorumlar (Yorum farklılıklarının sebepleri, Tasavvufi yorumlar)
